#!/usr/bin/env bash
# =====================================================================
# TigerAI GPU Driver + Docker Installer — arm64
# Path: deployments/compose-stack/00-system-setup-gpu-driver-and-docker/resource/arm64/install.sh
#
# WARNING: this script must stay at the FIRST level of resource/arm64/.
...
# <module>/resource/arm64/<this file>  ->  ../.. is the module directory.
