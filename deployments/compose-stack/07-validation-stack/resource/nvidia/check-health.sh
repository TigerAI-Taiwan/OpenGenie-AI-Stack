#!/usr/bin/env bash
# =====================================================================
# TigerAI Stack Health Validator — nvidia entry point
# Path: deployments/compose-stack/07-validation-stack/resource/nvidia/check-health.sh
#
...
#
# nvidia has no platform-specific checks: 06-ai-core-lemonade is amd-only, and
